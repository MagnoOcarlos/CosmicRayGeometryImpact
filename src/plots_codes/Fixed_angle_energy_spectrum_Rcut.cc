...
void criticalEnergy(double lb, double B)//draw a line in the critical energy position 
{
	...
	if (Ec >= 17.5)
	{
			...
			TLine *l = new TLine(Ec, 0.0, Ec, 100.0);
			l->SetLineColor(kRed);
			l->SetLineWidth(3);
			l->SetLineStyle(2);
			l->Draw();

			TText *t = new TText((Ec - 0.12), 15.7, "CE");
			t->SetTextAlign(22);
			t->SetTextColor(kRed);
			t->SetTextFont(10);
			t->SetTextFont(43);
...
int main(int argc, char *argv[])
{
	...
	// files names for the plot and its openings

	//The arrival energy file's name
	...
	//The injection energy file's name
	const char *filename_E_1 = "../energy0_1Mpc.txt";
	const char *filename_E_5 = "../energy0_5Mpc.txt";
	const char *filename_E_10 = "../energy0_10Mpc.txt";
	const char *filename_E_15 = "../energy0_15Mpc.txt";
	const char *filename_E_20 = "../energy0_20Mpc.txt";
	const char *filename_E_40 = "../energy0_40Mpc.txt";
	const char *filename_E_60 = "../energy0_60Mpc.txt";
	const char *filename_E_80 = "../energy0_80Mpc.txt";
	...
	ifstream E_f_1(filename_E_1);
	ifstream E_f_5(filename_E_5);
	ifstream E_f_10(filename_E_10);
	ifstream E_f_15(filename_E_15);
	ifstream E_f_20(filename_E_20);
	ifstream E_f_40(filename_E_40);
	ifstream E_f_60(filename_E_60);
	ifstream E_f_80(filename_E_80);

	// Filling the histograms
	hArrive1 = fillingHist(input1,E_f_1,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive5 = fillingHist(input5,E_f_5,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive10 = fillingHist(input10,E_f_10,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive15 = fillingHist(input15,E_f_15,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive20 = fillingHist(input20,E_f_20,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive40 = fillingHist(input40,E_f_40,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive60 = fillingHist(input60,E_f_60,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive80 = fillingHist(input80,E_f_80,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
