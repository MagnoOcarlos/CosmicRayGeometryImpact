...
int main(int argc, char *argv[])
{
	...
	const char *filename_E_100 = "../energy0_100Mpc.txt";
	const char *filename_E_120 = "../energy0_120Mpc.txt";
	const char *filename_E_160 = "../energy0_160Mpc.txt";
	const char *filename_E_200 = "../energy0_200Mpc.txt";
	const char *filename_E_240 = "../energy0_240Mpc.txt";
	...
	ifstream E_f_100(filename_E_100);
	ifstream E_f_120(filename_E_120);
	ifstream E_f_160(filename_E_160);
	ifstream E_f_200(filename_E_200);
	ifstream E_f_240(filename_E_240);
	
	// Filling the histograms
	hArrive100 = fillingHist(input100,E_f_100,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive120 = fillingHist(input120,E_f_120,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive160 = fillingHist(input160,E_f_160,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive200 = fillingHist(input200,E_f_200,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
	hArrive240 = fillingHist(input240,E_f_240,atof(argv[4]),atof(argv[5]),atoi(argv[6]));
