...
//Colocar energia critica dos dois núcleos
	...
	Ec2 = (0.9 * ((5+3+2)/3) * lb * B);
	Ec2 = log10(Ec2 * pow(10, 18));
	
	Ec3 = (0.9 *((7+6)*0.5) * lb * B);
	Ec3 = log10(Ec3 * pow(10, 18));
	...
	if (Ecp >= 17.5)
	{
		...
		TText *tp = new TText((Ecp - 0.12), .3, "CE");
		tp->SetTextAlign(22);
		...
		TText *t2 = new TText((Ec2 - 0.12), .3, "CE");
		t2->SetTextAlign(22);
		...
		TText *t3 = new TText((Ec3 - 0.12), .3, "CE");
		t3->SetTextAlign(22);
