...
//	TRint *rint = new TRint("", &argc, argv);	
	...
	const char *filename0  ="../energy_ang0.txt";
//	const char* filename20 ="../energy_ang20.txt";
	const char* filename40 ="../energy_ang40.txt";
//	const char* filename60 ="../energy_ang60.txt";
	const char* filename80 ="../energy_ang80.txt";
...
*/
	...
	auto leg = new TLegend(0.1,0.2,.45,.5);
	
	
	char pre[100]= "Angle 0#circ (N=";
	char su[100]=")";
...
/*		
	char pre20[100]= "Angle 20#circ (N=";
...
*/	
	...
	char pre40[100]= "Angle 40#circ (N=";
...
/*	
	char pre60[100]= "Angle 60#circ (N=";
...
*/
	char pre80[100]= "Angle 80#circ (N=";
