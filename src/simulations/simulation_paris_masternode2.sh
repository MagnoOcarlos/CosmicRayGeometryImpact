...
do
        ...
        do
			...
			#rm  dados_nitro/dadosNitro_radius_${R}_Mpc_${B}nG_lc_${lc}Mpc_seed1-NU.txt
                        ...
                        cat sim-A_${a}_Z_${z}_R_${R}_Mpc_B_${B}nG_lc_${lc}Mpc_seed*-CR* >>../../neutrinos/results/sim-A_${a}_Z_${z}_R_${R}_Mpc_B_${B}nG_lc_${lc}Mpc-CR.txt
                        cat sim-A_${a}_Z_${z}_R_${R}_Mpc_B_${B}nG_lc_${lc}Mpc_seed*-NU* >>../../neutrinos/results/sim-A_${a}_Z_${z}_R_${R}_Mpc_B_${B}nG_lc_${lc}Mpc-NU.txt
