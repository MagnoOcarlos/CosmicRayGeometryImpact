...
do
        ...
        do
                for B in 0.1 0.0001
                do
                        $exec_python simulation_paris.py 100000 $lc $R $B
                       ...
                       cat sim-A_55_Z_26_R_${R}_Mpc_${B}nG_lc_${lc}Mpc_one_sphere_seed1-CR.txt >../neutrinos/results/sim-A_55_Z_26_R_${R}_Mpc_${B}nG_lc_${lc}Mpc-CR.txt
                        rm  dados_nitro/dadosNitro_radius_${R}_Mpc_${B}nG_lc_${lc}Mpc_one_sphere_seed1.txt
                        sed -i -e '/^#/d' sim-A_55_Z_26_R_${R}_Mpc_${B}nG_lc_${lc}Mpc_one_sphere_seed*
                        cat sim-A_55_Z_26_R_${R}_Mpc_${B}nG_lc_${lc}Mpc_one_sphere_seed* >>../neutrinos/results/sim-A_55_Z_26_R_${R}_Mpc_${B}nG_lc_${lc}Mpc-CR.txt
                        rm *.txt
                done
        done
done
